...
export default function AttendAgentDemo() {
  const [messages, setMessages] = useState<Message[]>([
    {
      from: 'agent',
      text: 'Olá! 👋 Bem-vindo à Clínica Exemplo. Sou o Attend-Agent, assistente virtual 24/7. Como posso te ajudar hoje?',
      time: getTime(),
    },
  ]);
  ...
  const sendMessage = async (text: string) => {
    ...
    if (/quer um para|seu negócio|attend-agent/i.test(reply)) {
      setShowCTA(true);
    }
  };
    ...
    <div className="flex flex-col items-center gap-6">
        ...
        <div className="rounded-2xl overflow-hidden flex flex-col" style={{ height: '520px' }}>
          ...
          <div className="flex items-center gap-3 px-4 py-3 bg-[#075E54] shrink-0">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-white font-semibold text-sm">Clínica Exemplo · Attend-Agent</p>
      ...
      {showCTA && (
        <div className="w-full max-w-sm bg-gradient-to-br from-[#0097D6] to-[#007ab8] rounded-2xl p-6 text-center text-white shadow-lg shadow-[#0097D6]/30">
          <p className="font-bold text-lg mb-1">🚀 Esse é o Attend-Agent em ação!</p>
          <p className="text-sm text-white/80 mb-4">Quer um assim para sua empresa, funcionando 24/7?</p>
          <a
            href="https://wa.me/5571992732430?text=Quero%20saber%20mais%20sobre%20o%20Attend-Agent"
            target="_blank"
